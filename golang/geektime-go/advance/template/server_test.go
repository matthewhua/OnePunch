...
type UserService interface {
	Create(ctx context.Context, req *User) (resp *User, err error)
	Update(ctx context.Context, req *User) (*UpdateUserResp, error)
	GetById(ctx context.Context, req *GetUserReq) (resp *User, err error)
...
func TestUserService(t *testing.T) {
	...
	u, err := us.Create(context.Background(), &User{Name: "Matthew"})
	assert.Nil(t, err)
	assert.Equal(t, &User{Id: 12, Name: "Matthew"}, u)
