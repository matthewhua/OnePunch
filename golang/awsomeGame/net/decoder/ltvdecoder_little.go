...
func NewLTV_Little_Decoder() iface.IDecoder {
	return &LTV_Little_Decoder{}
}

func (ltv *LTV_Little_Decoder) GetLengthField() *iface.LengthField {
	// +---------------+---------------+---------------+
	// |    Length     |     Tag       |     Value     |
...
func (ltv *LTV_Little_Decoder) Intercept(chain iface.IChain) iface.IcResp {
