...
// (封包拆包实例初始化方法)
func NewDataPackLtv() iface.IDataPack {
	return &DataPackLtv{}
}
...
// (封包方法,压缩数据)
func (dp *DataPackLtv) Pack(msg iface.IMessage) ([]byte, error) {
...
// (拆包方法,解压数据)
func (dp *DataPackLtv) Unpack(binaryData []byte) (iface.IMessage, error) {
